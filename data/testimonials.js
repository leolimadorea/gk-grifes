export const testimonials = [
  {
    heading: "Melhor Loja de Celulares Online",
    text: "“ Sempre encontro modelos modernos e acessíveis nesta loja de celulares ”",
    name: "Roberto Silva",
    metas: "Cliente do Brasil",
  ...
  {
    heading: "Ótima Variedade e Qualidade",
    text: "Adoro a variedade de modelos e a alta qualidade dos celulares desta loja.",
    name: "Ana Costa",
    metas: "Cliente de Portugal",
  ...
  {
    heading: "Melhor Atendimento ao Cliente",
    text: "Finalmente encontrei uma loja de celulares com modelos de última geração e preços justos.",
    name: "Pedro Rocha",
    metas: "Cliente do Brasil",
    imageSrc: "/images/shop/products/img-p4.png",
    productTitle: "Xiaomi Redmi Note 12",
    price: "R$ 2.299,00",
    delay: ".2s",
  },
  {
    heading: "Preços Imbatíveis",
    text: "A loja oferece ótimos preços e entrega rápida, recomendo a todos!",
    name: "Helena Andrade",
    metas: "Cliente do Japão",
    imageSrc: "/images/shop/products/img-p5.png",
    productTitle: "Motorola Edge 40",
    price: "R$ 3.799,00",
    delay: ".3s",
  },
];
